...
public class Login_Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, 450, -1));
            ...
            try{
                ...
                if (rs.next()) {
                    ...
                    if (role.equals(admin.getStatus()) && akun.getUsername().equals(getUser)) {
                        ...
                        session.setLoggedInUsername(akun.getUsername());
                        DashboardKaryawan dashboard = new DashboardKaryawan();
